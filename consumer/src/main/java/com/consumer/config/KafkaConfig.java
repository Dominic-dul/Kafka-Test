...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, MyMsg> consumerFactory() {
        ...
        config.put("spring.json.type.mapping", "com.producer.model.MyMsg:com.consumer.model.MyMsg");    // This config tells mapper that these two classes although in different package but are same.
